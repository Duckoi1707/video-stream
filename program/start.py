...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("💵 Ủng Hộ Chủ Bot", url=f"https://t.me/{OWNER_NAME}"
                ),
            ]
        ]
    )

    alive = f"Đây Là Các Lệnh Cơ Bản Để Các Bạn Sử Dụng Được Bot Một Cách Trơn Tru ⌛
